...
import (
	...
	"github.com/minhhoccode111/go-clean-template-gin/internal/controller/amqp_rpc/v1/response"
...
func (r *V1) getTask() server.CallHandler {
	return func(d *amqp.Delivery) (any, error) {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("amqp_rpc - V1 - getTask - extractUserID: %w", err)
		}
...
func (r *V1) listTasks() server.CallHandler {
	return func(d *amqp.Delivery) (any, error) {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("amqp_rpc - V1 - listTasks - extractUserID: %w", err)
		}
...
func (r *V1) updateTask() server.CallHandler {
	return func(d *amqp.Delivery) (any, error) {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("amqp_rpc - V1 - updateTask - extractUserID: %w", err)
		}
...
func (r *V1) transitionTask() server.CallHandler {
	return func(d *amqp.Delivery) (any, error) {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("amqp_rpc - V1 - transitionTask - extractUserID: %w", err)
		}
...
func (r *V1) deleteTask() server.CallHandler {
	return func(d *amqp.Delivery) (any, error) {
		...
		if err != nil {
			...
			return nil, fmt.Errorf("amqp_rpc - V1 - deleteTask - extractUserID: %w", err)
		}
