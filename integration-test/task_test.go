...
const (
	...
	grpcDescription = "grpc description"
	updatedGrpcTask = "updated grpc task"
)
...
func TestGRPCTaskUpdateTransitionDeleteV1(t *testing.T) {
	...
	if updateResp.GetTitle() != updatedGrpcTask {
...
func TestRMQTaskV1(t *testing.T) {
	...
	createPayload := authenticatedPayload(token, map[string]string{
		keyTitle:       "rmq task",
		keyDescription: "rmq description",
	})
...
func TestNATSTaskV1(t *testing.T) {
	...
	createPayload := authenticatedPayload(token, map[string]string{
		keyTitle:       "nats task",
		keyDescription: "nats description",
	})
